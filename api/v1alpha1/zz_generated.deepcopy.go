...
func (in *PageSizeStatus) DeepCopyInto(out *PageSizeStatus) {
	*out = *in
	if in.Size != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PageSizeStatus.
func (in *PageSizeStatus) DeepCopy() *PageSizeStatus {
	if in == nil {
		return nil
	}
	out := new(PageSizeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StaticSiteStatus) DeepCopyInto(out *StaticSiteStatus) {
	*out = *in
	...
	if in.TotalPagesSize != nil {
		in, out := &in.TotalPagesSize, &out.TotalPagesSize
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.PageSizes != nil {
		in, out := &in.PageSizes, &out.PageSizes
		*out = make([]PageSizeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
